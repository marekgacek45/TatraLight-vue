<template>
    <div>
        ...
        <!--LAYOUT-->
        <MainLayout
            bgImage="bg-[url('/assets/images/small/tl-small_5.webp')] sm:bg-[url('/assets/images/big/tl-big_5.webp')] bg-cover bg-center bg-gray-300 bg-blend-multiply"
        >
            <!--HEADER-->
            <template #headerContent>
                <HeadingBox heading="Polityka Prywatności"
                    ></HeadingBox
                >
            </template>
            <!--MAIN-->
            <template #mainContent>
               <div  class="overflow-x-auto border border-primaryColor rounded-lg p-4">
                    <h2>Polityka Prywatności</h2>

                    <p>
                        Niniejsza polityka dotyczy Serwisu www, funkcjonującego
                        pod adresem url:
                        <a href="https://tatralight.pl">tatralight.pl</a>
                    </p>

                    <p>
                        Operatorem serwisu oraz Administratorem danych osobowych
                        jest: tatralight.pl oś. Bór 2/1, 34-400 Nowy Targ
                    </p>

                    <p>
                        Adres kontaktowy poczty elektronicznej operatora:
                        <a href="mailto:biuro@tatralight.pl"
                            >biuro@tatralight.pl</a
                        >
                    </p>
                    ...
                    <span
                        ...
                        użytkownikach i ich zachowaniu w następujący
                        sposób:</span
                    >
                    <ul>
                        <li>
                    ...
                    <h2>Wybrane Metody Ochrony Danych</h2>
                    ...
                    <p>
                        Hasła użytkowników są przechowywane w postaci
                        hashowanej. Funkcja hashująca działa jednokierunkowo -
                        nie jest możliwe odwrócenie jej działania, co stanowi
                        obecnie współczesny standard w zakresie przechowywania
                        haseł użytkowników.
                    </p>
                    ...
                    <h2>Hosting i Logi Serwerowe</h2>

                    <p>
                        Serwis jest hostowany (technicznie utrzymywany) na
                        serwerach operatora: HOSTIDO
                    </p>
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            samodzielnego zamawiania usług poprzez rejestratory
                            na stronie,
                        </li>
                        <li>
                            informacje związane z obsługą poczty elektronicznej
                            kierowanej do Operatora oraz wysyłanej przez
                            Operatora.
                        </li>
                    </ul>
                    ...
                    <span
                        ...
                        Administratorze. Dotyczy to takich grup odbiorców:</span
                    >
                    ...
                    <ul>
                        ...
                        <li>
                            firmy, świadczące usługi marketingu na rzecz
                            Administratora.
                        </li>
                    </ul>
                    ...
                    <span>Przysługuje Ci prawo żądania od Administratora:</span>
                    <ul>
                    ...
                    <p>
                        Dane osobowe nie są przekazywane do krajów trzecich w
...
<h2>Logi Administratora i Techniki Marketingowe</h2>
...
<h2>Informacja o Plikach Cookies</h2>
    ...
    <span>Pliki cookies wykorzystywane są w następujących celach:</span>
    <ul>
    ...
    <h2>Zarządzanie Plikami Cookies – Jak Wyrażać i Cofać Zgodę?</h2>
...
<span>W celu zarządzania ustawieniami cookies wybierz z listy poniżej przeglądarkę internetową, której używasz, i postępuj zgodnie z instrukcjami:</span>

<ul>
    <li><a href="https://support.microsoft.com/pl-pl/microsoft-edge/usuwanie-plikow-cookie-w-microsoft-edge-63947406-40ac-c3b8-57b9-2a946a29ae09" target="_blank">Microsoft Edge</a></li>
    <li><a href="https://support.microsoft.com/pl-pl/help/278835/how-to-delete-cookie-files-in-internet-explorer" target="_blank">Internet Explorer</a></li>
    <li><a href="https://support.google.com/chrome/answer/95647?hl=pl" target="_blank">Chrome</a></li>
    <li><a href="https://support.apple.com/pl-pl/guide/safari/sfri11471/mac" target="_blank">Safari</a></li>
    <li><a href="https://support.mozilla.org/pl/kb/Włączanie i wyłączanie obsługi ciasteczek" target="_blank">Firefox</a></li>
    <li><a href="https://help.opera.com/pl/latest/web-preferences/#cookies" target="_blank">Opera</a></li>
</ul>

<span><strong>Urządzenia mobilne:</strong></span>

<ul>
    <li><a href="https://support.google.com/chrome/answer/95647?hl=pl&co=GENIE.Platform%3DAndroid&oco=1" target="_blank">Android</a></li>
    <li><a href="https://support.apple.com/pl-pl/HT201265" target="_blank">Safari (iOS)</a></li>
    <li><a href="https://support.microsoft.com/pl-pl/help/11696/windows-phone-7" target="_blank">Windows Phone</a></li>
</ul>
